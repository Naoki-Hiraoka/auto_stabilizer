...
public:
  ...
  std::vector<double> muTrans = std::vector<double>(2, 0.3); // 要素数2. 0: rleg, 1: lleg. 足裏の摩擦係数. 0より大きい
  std::vector<double> muRot = std::vector<double>(2, 0.03); // 要素数2. 0: rleg, 1: lleg. 足裏の回転摩擦係数. 0より大きい
